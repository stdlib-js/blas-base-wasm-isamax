...
// Attached to the main export is a `main` method which returns a number...
{
	...
	isamax.main( x.length, x, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	isamax.main( '10', x, 1 ); // $ExpectError
	isamax.main( true, x, 1 ); // $ExpectError
	isamax.main( false, x, 1 ); // $ExpectError
	isamax.main( null, x, 1 ); // $ExpectError
	isamax.main( undefined, x, 1 ); // $ExpectError
	isamax.main( [], x, 1 ); // $ExpectError
	isamax.main( {}, x, 1 ); // $ExpectError
	isamax.main( ( x: number ): number => x, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Float32Array...
{
	...
	isamax.main( x.length, 10, 1 ); // $ExpectError
	isamax.main( x.length, '10', 1 ); // $ExpectError
	isamax.main( x.length, true, 1 ); // $ExpectError
	isamax.main( x.length, false, 1 ); // $ExpectError
	isamax.main( x.length, null, 1 ); // $ExpectError
	isamax.main( x.length, undefined, 1 ); // $ExpectError
	isamax.main( x.length, [], 1 ); // $ExpectError
	isamax.main( x.length, {}, 1 ); // $ExpectError
	isamax.main( x.length, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	isamax.main( x.length, x, '10' ); // $ExpectError
	isamax.main( x.length, x, true ); // $ExpectError
	isamax.main( x.length, x, false ); // $ExpectError
	isamax.main( x.length, x, null ); // $ExpectError
	isamax.main( x.length, x, undefined ); // $ExpectError
	isamax.main( x.length, x, [] ); // $ExpectError
	isamax.main( x.length, x, {} ); // $ExpectError
	isamax.main( x.length, x, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	isamax.main(); // $ExpectError
	isamax.main( x.length ); // $ExpectError
	isamax.main( x.length, x ); // $ExpectError
	isamax.main( x.length, x, 1, 10 ); // $ExpectError
}
...
// Attached to main export is an `ndarray` method which returns a number...
{
	...
	isamax.ndarray( x.length, x, 1, 0 ); // $ExpectType number
}
...
// The compiler throws an error if the `ndarray` method is provided a first argument which is not a number...
{
	...
	isamax.ndarray( '10', x, 1, 0 ); // $ExpectError
	isamax.ndarray( true, x, 1, 0 ); // $ExpectError
	isamax.ndarray( false, x, 1, 0 ); // $ExpectError
	isamax.ndarray( null, x, 1, 0 ); // $ExpectError
	isamax.ndarray( undefined, x, 1, 0 ); // $ExpectError
	isamax.ndarray( [], x, 1, 0 ); // $ExpectError
	isamax.ndarray( {}, x, 1, 0 ); // $ExpectError
	isamax.ndarray( ( x: number ): number => x, x, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a second argument which is not a Float32Array...
{
	...
	isamax.ndarray( x.length, 10, 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, '10', 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, true, 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, false, 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, null, 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, undefined, 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, [], 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, {}, 1, 0 ); // $ExpectError
	isamax.ndarray( x.length, ( x: number ): number => x, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a third argument which is not a number...
{
	...
	isamax.ndarray( x.length, x, '10', 0 ); // $ExpectError
	isamax.ndarray( x.length, x, true, 0 ); // $ExpectError
	isamax.ndarray( x.length, x, false, 0 ); // $ExpectError
	isamax.ndarray( x.length, x, null, 0 ); // $ExpectError
	isamax.ndarray( x.length, x, undefined, 0 ); // $ExpectError
	isamax.ndarray( x.length, x, [], 0 ); // $ExpectError
	isamax.ndarray( x.length, x, {}, 0 ); // $ExpectError
	isamax.ndarray( x.length, x, ( x: number ): number => x, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a fourth argument which is not a number...
{
	...
	isamax.ndarray( x.length, x, 1, '10' ); // $ExpectError
	isamax.ndarray( x.length, x, 1, true ); // $ExpectError
	isamax.ndarray( x.length, x, 1, false ); // $ExpectError
	isamax.ndarray( x.length, x, 1, null ); // $ExpectError
	isamax.ndarray( x.length, x, 1, undefined ); // $ExpectError
	isamax.ndarray( x.length, x, 1, [] ); // $ExpectError
	isamax.ndarray( x.length, x, 1, {} ); // $ExpectError
	isamax.ndarray( x.length, x, 1, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided an unsupported number of arguments...
{
	...
	isamax.ndarray(); // $ExpectError
	isamax.ndarray( x.length ); // $ExpectError
	isamax.ndarray( x.length, x ); // $ExpectError
	isamax.ndarray( x.length, x, 1 ); // $ExpectError
	isamax.ndarray( x.length, x, 1, 0, 10 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	isamax.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	isamax.Module( '10' ); // $ExpectError
	isamax.Module( true ); // $ExpectError
	isamax.Module( false ); // $ExpectError
	isamax.Module( null ); // $ExpectError
	isamax.Module( undefined ); // $ExpectError
	isamax.Module( [] ); // $ExpectError
	isamax.Module( {} ); // $ExpectError
	isamax.Module( ( x: number ): number => x ); // $ExpectError
}
