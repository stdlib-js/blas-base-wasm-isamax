...
* isamax.write( xptr, oneTo( N, dtype ) );
*
* // Perform computation:
* var idx = isamax.main( N, xptr, 1 );
* // returns 4
*/
...
* // returns 4
*/
setReadOnly( Module.prototype, 'main', function isamax( N, xptr, strideX ) {
	return this._instance.exports.c_isamax( N, xptr, strideX );
});
...
*
* // Perform computation:
* var idx = isamax.ndarray( N, xptr, 1, 0 );
* // returns 4
*/
setReadOnly( Module.prototype, 'ndarray', function isamax( N, xptr, strideX, offsetX ) {
	return this._instance.exports.c_isamax_ndarray( N, xptr, strideX, offsetX );
});
