...
```javascript
isamax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-isamax@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-wasm-isamax/tags). For example,

```javascript
isamax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-isamax@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var isamax = require( 'path/to/vendor/umd/blas-base-wasm-isamax/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-isamax@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-base-wasm-isamax.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-base-wasm-isamax

[test-image]: https://github.com/stdlib-js/blas-base-wasm-isamax/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-wasm-isamax/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-base-wasm-isamax/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-base-wasm-isamax?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-base-wasm-isamax.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-base-wasm-isamax/main
...
[branches-url]: https://github.com/stdlib-js/blas-base-wasm-isamax/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-base-wasm-isamax/main/LICENSE

[blas]: http://www.netlib.org/blas

[isamax]: https://www.netlib.org/lapack/explore-html/dd/d52/group__iamax_ga68e936c3ea980ed3916cc159f969b440.html#ga68e936c3ea980ed3916cc159f969b440
...
[@stdlib/blas/base/isamax]: https://github.com/stdlib-js/blas-base-isamax/tree/umd
