...
tape( 'a module instance has a `main` method which supports a negative `stride` parameter', function test( t ) {
	...
	mod.write( xp, new Float32Array( [ 3.0, -4.0, 1.0, 15.0, 4.0, 3.0 ] ) );

	idx = mod.main( 6, xp, -1 );
	t.strictEqual( idx, 2, 'returns expected value' );

	mod.write( xp, new Float32Array( [ 3.0, 999.9, 999.9, -4.0, 999.9, 999.9, 1.0, 999.9, 999.9, 15.0, 999.9, 999.9, 4.0, 999.9, 999.9, 3.0 ] ) ); // eslint-disable-line max-len
